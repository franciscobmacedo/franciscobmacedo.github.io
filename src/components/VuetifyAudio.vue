<template>
    <v-card style="text-align: center" :flat="flat == undefined || flat == false  ? false : true">
        ...
        <audio id="player" ref="player" v-on:ended="ended" v-on:canplay="canPlay" :src="require(`@/assets/audio/${file}`)"></audio>
    </v-card>
</template>
<script>
...
import { mapState } from 'vuex'
    ...
    export default {
        ...
        currentlyPlaying(isPlaying){
                ...
                if (isPlaying){
                    // console.log("isPlaying: ", this.id)
                    this.$store.commit('setMusic', this.id)
                }
            },
            musicPlaying(newID){
                // console.log('stop/start', newID)
        ...
        methods: {
            ...
            stop () {
                ...
                // this.$store.commit('stopMusic', this.id)
